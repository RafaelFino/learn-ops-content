...
q("Acho que entendi... legal esse negócio de salário hein?")
t(" .NET Framework:")
t(" - Plataforma: .NET")
...
q("E esse ainda é multiplataforma? Eles pagam bem tbm? Parece que todos pagabem bem...")
s("Mas que raios é esse .net core aí que vc falou?")
