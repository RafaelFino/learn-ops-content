...
t("Olá, padawan! Hoje vamos falar sobre dual boot. Alias, como funciona o boot de um computador...")
t("Você sabe o que é boot?")
s(f"Não, {c.Teacher()}. Que desgraça é essa?")
t("Calma, padawan! Boot é o processo de inicialização do computador.")
...
t("Sim, padawan! O sistema operacional é o que você usa para tudo!")
...
t("Bom, padawan! Aqui que a coisa fica ainda mais complexa, mas vou tentar simplificar...")
...
t("Sim, padawan! O GRUB é um gerenciador de boot muito usado no Linux.")
...
t("Bom, padawan! Quando você atualiza o Windows, ele pode apagar o GRUB.")
...
t("Não, padawan! O Windows não consegue recuperar o GRUB.")
t("Você precisa usar o Linux para reinstalar o GRUB.")
q("E o Windows não saberia ser esse meu gerenciador de boot?")
t("Não, padawan! O Windows não sabe ser gerenciador de boot.")
...
t("É, padawan! O Windows é assim mesmo.")
...
t("Não, padawan! Você não precisa saber de tudo isso.")
t("Mas é bom saber o básico.")
q("Consigo instalar o Refind no meu computador com Linux?")
t("Sim, padawan! Você pode instalar o Refind no seu computador com Linux.")
