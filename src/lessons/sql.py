...
s("Não faço ideia, {c.Teacher()}. Conta pra mim!")
...
s("Esses códigos estão ficando complexos, {c.Teacher()}. Mas estou entendendo! Eu consigo usar algum tipo de identação para organizar melhor?")
...
s("E como eu posso começar a praticar com o SQLite Studio?")
t("Você pode começar a praticar com o SQLite Studio criando um banco de dados, criando tabelas, inserindo dados, atualizando dados, excluindo dados e executando consultas SQL. O importante é praticar e se familiarizar com a linguagem.")
s("Entendi! Obrigado por todas as informações, {c.Teacher()}! Vou começar a praticar com o SQLite e o SQLite Studio para aprender mais sobre SQL.")