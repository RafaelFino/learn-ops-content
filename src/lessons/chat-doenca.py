...
t("101 - Switching Protocols, quer dizer que a requisição foi recebida e o servidor está mudando de protocolo, é usado quando você tentar enviar uma informação e o servidor está mudando de protocolo")
t("102 - Processing, quer dizer que a requisição foi recebida e o servidor está processando a requisição, é usado quando você tentar enviar uma informação e o servidor está processando a requisição")
t("103 - Early Hints, quer dizer que a requisição foi recebida e o servidor está enviando dicas, é usado quando você tentar enviar uma informação e o servidor está enviando dicas")
t("104 - Unassigned, quer dizer que a requisição foi recebida e o servidor está processando a requisição, é usado quando você tentar enviar uma informação e o servidor está processando a requisição")
...
t("Os mais comuns são:")
t("400 - Bad Request, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e houve um erro na requisição, você deve verificar a requisição, provavelmente você tentou acessar uma página e houve um erro na requisição")
t("401 - Unauthorized, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e você não está autorizado, você deve verificar a requisição, provavelmente você tentou acessar uma página e você não está autorizado")
t("402 - Payment Required, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o pagamento é necessário, você deve verificar a requisição, provavelmente você tentou acessar uma página e o pagamento é necessário")
t("403 - Forbidden, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e você não tem permissão, você deve verificar a requisição, provavelmente você tentou acessar uma página e você não tem permissão")
t("404 - Not Found, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a página não foi encontrada, você deve verificar a requisição, provavelmente você tentou acessar uma página e a página não foi encontrada")
t("405 - Method Not Allowed, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o método não é permitido, você deve verificar a requisição, provavelmente você tentou acessar uma página e o método não é permitido")
t("406 - Not Acceptable, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o conteúdo não é aceitável, você deve verificar a requisição, provavelmente você tentou acessar uma página e o conteúdo não é aceitável")
t("407 - Proxy Authentication Required, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a autenticação do proxy é necessária, você deve verificar a requisição, provavelmente você tentou acessar uma página e a autenticação do proxy é necessária")
t("408 - Request Timeout, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o tempo de requisição expirou, você deve verificar a requisição, provavelmente você tentou acessar uma página e o tempo de requisição expirou")
t("409 - Conflict, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e houve um conflito, você deve verificar a requisição, provavelmente você tentou acessar uma página e houve um conflito")
t("410 - Gone, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a página não está mais disponível, você deve verificar a requisição, provavelmente você tentou acessar uma página e a página não está mais disponível")
t("411 - Length Required, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o comprimento é necessário, você deve verificar a requisição, provavelmente você tentou acessar uma página e o comprimento é necessário")
t("412 - Precondition Failed, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a condição prévia falhou, você deve verificar a requisição, provavelmente você tentou acessar uma página e a condição prévia falhou")
t("413 - Payload Too Large, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a carga é muito grande, você deve verificar a requisição, provavelmente você tentou acessar uma página e a carga é muito grande")
t("414 - URI Too Long, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o URI é muito longo, você deve verificar a requisição, provavelmente você tentou acessar uma página e o URI é muito longo")
t("415 - Unsupported Media Type, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o tipo de mídia não é suportado, você deve verificar a requisição, provavelmente você tentou acessar uma página e o tipo de mídia não é suportado")
t("416 - Range Not Satisfiable, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o intervalo não é satisfatório, você deve verificar a requisição, provavelmente você tentou acessar uma página e o intervalo não é satisfatório")
t("417 - Expectation Failed, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a expectativa falhou, você deve verificar a requisição, provavelmente você tentou acessar uma página e a expectativa falhou")
t("418 - I'm a teapot, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o servidor é uma chaleira, você deve verificar a requisição, provavelmente você tentou acessar uma página e o servidor é uma chaleira")
t("420 - Method Failure, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o método falhou, você deve verificar a requisição, provavelmente você tentou acessar uma página e o método falhou")
t("421 - Misdirected Request, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a requisição foi mal direcionada, você deve verificar a requisição, provavelmente você tentou acessar uma página e a requisição foi mal direcionada")
t("422 - Unprocessable Entity, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a entidade não pode ser processada, você deve verificar a requisição, provavelmente você tentou acessar uma página e a entidade não pode ser processada")
t("423 - Locked, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e ela está bloqueada, você deve verificar a requisição, provavelmente você tentou acessar uma página e ela está bloqueada")
t("424 - Failed Dependency, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a dependência falhou, você deve verificar a requisição, provavelmente você tentou acessar uma página e a dependência falhou")
t("425 - Too Early, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e é muito cedo, você deve verificar a requisição, provavelmente você tentou acessar uma página e é muito cedo")
t("426 - Upgrade Required, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a atualização é necessária, você deve verificar a requisição, provavelmente você tentou acessar uma página e a atualização é necessária")
t("428 - Precondition Required, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a condição prévia é necessária, você deve verificar a requisição, provavelmente você tentou acessar uma página e a condição prévia é necessária")
t("429 - Too Many Requests, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e há muitas requisições, você deve verificar a requisição, provavelmente você tentou acessar uma página e há muitas requisições")
t("431 - Request Header Fields Too Large, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e os cabeçalhos da requisição são muito grandes, você deve verificar a requisição, provavelmente você tentou acessar uma página e os cabeçalhos da requisição são muito grandes")
t("451 - Unavailable For Legal Reasons, quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e ela está indisponível por razões legais, você deve verificar a requisição, provavelmente você tentou acessar uma página e ela está indisponível por razões legais")
...
t("Os mais comuns são:")
t("500 - Internal Server Error, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e houve um erro no servidor, você deve verificar o servidor, provavelmente houve um erro no servidor, é um retorno bem comum de erro no servidor, praticamente um erro genérico, aconteceu alguma caquinha lá no server!!!")
t("501 - Not Implemented, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e a página não foi implementada, você deve verificar o servidor, provavelmente a página não foi implementada, é um retorno comum de erro no servidor, geralmente é sinal de uma API que não foi implementada corretamente... QUE VERGONHA!!")
t("502 - Bad Gateway, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e o gateway está ruim, você deve verificar o servidor, provavelmente o gateway está ruim, é um retorno comum de erro no servidor, geralmente é sinal de um gateway que está ruim ou não há conectividade com algum endereço do server... algo muito errado aconteceu!!!")
t("503 - Service Unavailable, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e o serviço está indisponível, você deve verificar o servidor, provavelmente o serviço está indisponível, é um retorno comum de erro no servidor, geralmente é sinal de um serviço que está indisponível, ou seja, o servidor está fora do ar!!!")
t("504 - Gateway Timeout, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e o gateway expirou, você deve verificar o servidor, provavelmente o gateway expirou, é um retorno comum de erro no servidor, geralmente é sinal de um gateway que expirou, ou seja, o gateway está fora do ar ou não respondeu a tempo... mais uma desgraça que merece perder a vontade de cantar uma bela canção!!")
t("505 - HTTP Version Not Supported, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e a versão do HTTP não é suportada, você deve verificar o servidor, provavelmente a versão do HTTP não é suportada, é um retorno comum de erro no servidor, geralmente é sinal de uma versão do HTTP que não é suportada, ou seja, o servidor não suporta a versão do HTTP que você está usando... vocês precisam se entender melhor!!!")
t("506 - Variant Also Negotiates, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e a variante também negocia, você deve verificar o servidor, provavelmente a variante também negocia, é um retorno comum de erro no servidor, geralmente é sinal de uma variante que também negocia, ou seja, a variante também negocia... pessoal, o jogo precisa ser alinhado antes!!")
t("507 - Insufficient Storage, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e o armazenamento é insuficiente, você deve verificar o servidor, provavelmente o armazenamento é insuficiente, é um retorno comum de erro no servidor, geralmente é sinal de um armazenamento que é insuficiente, ou seja, o armazenamento é insuficiente... é um dos erros mais primários e básicos ao lidar com um server, É MUITO AMADOR!")
t("508 - Loop Detected, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e o loop foi detectado, você deve verificar o servidor, provavelmente o loop foi detectado, é um retorno comum de erro no servidor, geralmente é sinal de um loop que foi detectado, ou seja, o loop foi detectado... é um erro que pode ser evitado com um pouco mais de atenção e cuidado!!")
t("510 - Not Extended, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e a extensão não foi feita, você deve verificar o servidor, provavelmente a extensão não foi feita, é um retorno comum de erro no servidor, geralmente é sinal de uma extensão que não foi feita, ou seja, a extensão não foi feita... pegou que quase sempre é cagada do pessoal que fez ou cuida do server?")
t("511 - Network Authentication Required, quer dizer que houve um erro no servidor, é usado quando você tentar acessar uma página e a autenticação de rede é necessária, você deve verificar o servidor, provavelmente a autenticação de rede é necessária, é um retorno comum de erro no servidor, geralmente é sinal de uma autenticação de rede que é necessária, ou seja, a autenticação de rede é necessária... algo não está ok, mas é um erro que pode ser corrigido com alterações de configuração do server")
q("E quando eles acontecem? consegue me dar exemplos simples usando a carta?")
t("Então, os retornos 5xx são códigos de erro do servidor, eles informam que houve um erro no servidor, por exemplo, o código 500 informa que houve um erro no servidor")
...
t("| HEAD    | 403      | Forbidden       | Proibido                | Quando você não tem permissão para acessar a página                           |")
t("| OPTIONS | 405      | Method Not      | Método não permitido    | Quando o método não é permitido                                               |")
t("| CONNECT | 407      | Proxy Auth      | Autenticação do proxy   | Quando a autenticação do proxy é necessária                                   |")
t("| TRACE   | 408      | Request         | Tempo de requisição     | Quando o tempo de requisição expirou                                          |")
t("| GET     | 418      | I'm a Teapo     | Eu sou uma chaleira     | Quando o servidor é uma chaleira                                              |")
t("| POST    | 420      | Method          | Método falhou           | Quando o método falhou                                                        |")
t("| PUT     | 421      | Misdirected     | Requisição mal feita    | Quando a requisição foi mal direcionada                                       |")
t("| DELETE  | 430      | Request headers | Cabeçalhos mto grandes  | Quando os cabeçalhos da requisição são muito grandes                          |")
t("| GET     | 500      | ERROR           | Erro no servidor        | Quando houve um erro no servidor                                              |")
t("|------------------------------------------------------------------------------------------------------------------------------------------------|")
...
t("|--------------------------------------------------------------------------------------------------------------------------------------------|")
t("Ainda existem códigos não oficiais, as vezes são piadas, vamos dar uma olhada neles:")
t("218 - This is fine - Apache: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o servidor está pegando fogo, você deve verificar o servidor, provavelmente o servidor está pegando fogo, é um retorno não oficial de erro no servidor, geralmente é sinal de um servidor que está pegando fogo, ou seja, o servidor está pegando fogo... é um erro que pode ser corrigido com um extintor de incêndio")
t("419 - Page Expired - Laravel: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a página expirou, você deve verificar a requisição, provavelmente a página expirou, é um retorno não oficial de erro na requisição, geralmente é sinal de uma página que expirou, ou seja, a página expirou... é um erro que pode ser corrigido com uma nova requisição")
t("420 - Method Failure - Spring Framework: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o método falhou, você deve verificar a requisição, provavelmente o método falhou, é um retorno não oficial de erro na requisição, geralmente é sinal de um método que falhou, ou seja, o método falhou... é um erro que pode ser corrigido com um novo método")
t("420 - Enhance Your Calm - Twitter: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e você deve melhorar a calma, você deve verificar a requisição, provavelmente você deve melhorar a calma, é um retorno não oficial de erro na requisição, geralmente é sinal de que você deve melhorar a calma, ou seja, você deve melhorar a calma... é um erro que pode ser corrigido com uma nova requisição")
t("421 - Misdirected Request - NGINX: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e a requisição foi mal direcionada, você deve verificar a requisição, provavelmente a requisição foi mal direcionada, é um retorno não oficial de erro na requisição, geralmente é sinal de uma requisição que foi mal direcionada, ou seja, a requisição foi mal direcionada... é um erro que pode ser corrigido com uma nova requisição")
t("430 - Request Header Fields Too Large - NGINX/Shopfy: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e os cabeçalhos da requisição são muito grandes, você deve verificar a requisição, provavelmente os cabeçalhos da requisição são muito grandes, é um retorno não oficial de erro na requisição, geralmente é sinal de que os cabeçalhos da requisição são muito grandes, ou seja, os cabeçalhos da requisição são muito grandes... é um erro que pode ser corrigido com uma nova requisição")
t("450 - Blocked by Windows Parental Controls - Microsoft: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e ela está bloqueada pelos controles parentais do Windows, você deve verificar a requisição, provavelmente a página está bloqueada pelos controles parentais do Windows, é um retorno não oficial de erro na requisição, geralmente é sinal de que a página está bloqueada pelos controles parentais do Windows, ou seja, a página está bloqueada pelos controles parentais do Windows... é um erro que pode ser corrigido com a liberação da página pelos controles parentais do Windows")
t("498 - Invalid Token - Esri: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o token é inválido, você deve verificar a requisição, provavelmente o token é inválido, é um retorno não oficial de erro na requisição, geralmente é sinal de que o token é inválido, ou seja, o token é inválido... é um erro que pode ser corrigido com um novo token")
t("499 - Token Required - Esri: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o token é necessário, você deve verificar a requisição, provavelmente o token é necessário, é um retorno não oficial de erro na requisição, geralmente é sinal de que o token é necessário, ou seja, o token é necessário... é um erro que pode ser corrigido com um novo token")
t("509 - Bandwidth Limit Exceeded - Apache: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o limite de banda foi excedido, você deve verificar a requisição, provavelmente o limite de banda foi excedido, é um retorno não oficial de erro na requisição, geralmente é sinal de que o limite de banda foi excedido, ou seja, o limite de banda foi excedido... é um erro que pode ser corrigido com um novo limite de banda")
t("529 - Site is overloaded - Qualys: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o site está sobrecarregado, você deve verificar a requisição, provavelmente o site está sobrecarregado, é um retorno não oficial de erro na requisição, geralmente é sinal de que o site está sobrecarregado, ou seja, o site está sobrecarregado... é um erro que pode ser corrigido com uma nova requisição")
t("530 - Site is frozen - Pantheon: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o site está congelado, você deve verificar a requisição, provavelmente o site está congelado, é um retorno não oficial de erro na requisição, geralmente é sinal de que o site está congelado, ou seja, o site está congelado... é um erro que pode ser corrigido com uma nova requisição")
t("530 - Origin DNS Error - Cloudflare: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o DNS de origem está com erro, você deve verificar a requisição, provavelmente o DNS de origem está com erro, é um retorno não oficial de erro na requisição, geralmente é sinal de que o DNS de origem está com erro, ou seja, o DNS de origem está com erro... é um erro que pode ser corrigido com uma nova requisição")
t("540 - Site is stopped - Pantheon: quer dizer que houve um erro na requisição, é usado quando você tentar acessar uma página e o site está parado, você deve verificar a requisição, provavelmente o site está parado, é um retorno não oficial de erro na requisição, geralmente é sinal de que o site está parado, ou seja, o site está parado... é um erro que pode ser corrigido com uma nova requisição")
t("São muitos, você pode dar uma olhada em https://en.wikipedia.org/wiki/List_of_HTTP_status_codes para ter mais detalhes...")
s(f"Entendi {c.Teacher()}, pelo menos acho que agora eu entendi melhor... poderia então fazer um super resumo disso tudo para podermos ir para o chat?")
