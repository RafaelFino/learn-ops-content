...
c.StudentComment(
    """Oi, professor! Já ouvi um pouco, mas não entendo muito bem o que é. Pode me explicar?""")
...
c.StudentComment(
    """E se eu quiser adicionar uma nova entrada para um sistema operacional que não está aparecendo?""")
...
c.Speak(
    """- *"The GRUB Manual"*: Disponível no [site oficial do GNU GRUB](https://www.gnu.org/software/grub/manual/grub/grub.html)""")
