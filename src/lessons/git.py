...
c.StudentComment(
    """Entendi! Mas como eu faço para criar um repositório no GitHub?""")
...
c.StudentComment(
    """Entendi! Mas como eu faço para adicionar arquivos ao meu repositório?""")
...
c.StudentComment(
    """Mas eu não criei nenhum arquivo ainda... como podemos seguir?""")
...
c.StudentComment(
    """Entendi! Mas e se eu quiser fazer alterações no meu código?""")
...
c.StudentComment(
    """Não entendi direito, o que é uma branch? Quais problemas ela resolve?""")
...
c.StudentComment(
    """Entendi! Mas e se eu quiser adicionar as alterações de outra pessoa ao meu código?""")
...
c.StudentComment(
    """Entendi! Mas e se eu quiser fazer alterações no código de outra pessoa?""")
...
c.Speak("""Se as suas alterações forem aceitas, elas são adicionadas ao código principal.""")
c.StudentComment(
    """Entendi! Mas e se eu quiser fazer um clone do código de outra pessoa?""")
...
c.Speak("""Se as suas alterações forem aceitas, elas são adicionadas ao código principal.""")
c.StudentComment(
    """Isso aqui é um mundo novo... como esse tipo de coisa era feita antes do Git?""")
