...
c.StudentComment("Não entendi nada... pode explicar de novo de uma forma mais simples? Não esquece que eu sou meio burro e não entendo nada dessa coisa toda")
...
c.StudentComment("Ah, é tipo um dentro do outro? que loucura... e não fica pesado demais para um computador rodar outro dentro dele?")
...
c.StudentComment("Eu uso Windows, será que consigo fazer isso no Windows?")
...
c.StudentComment("Entendi... então os containers são como máquinas virtuais, mas mais leves e eficientes, porque compartilham recursos com o sistema operacional do servidor físico? Você poderia me explicar isso de uma forma mais simples?")
...
c.StudentComment("Docker Hub? Como assim? O que é isso?")
...
c.StudentComment("Eu consigo criar um container com o Docker para executar aplicações Windows?")
...
c.StudentComment("Entendi... e como eu posso criar um container com o Docker? No Linux mesmo, como os adultos fazem...")
...
c.StudentComment("Sim, Fino! Aprendi muito sobre Docker, containers e virtualização! Legal... mas estou aqui pensando, será que o Docker é o futuro da computação?")
...
c.StudentComment("Que legal! E como eu consigo lidar com um container desses em forma de código? como funciona esse tipo de automação?")
